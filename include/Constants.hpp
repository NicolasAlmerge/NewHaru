...
namespace pdf {
    ...
    /// Represents all allowed values for the R3 encryption.
    ...
    /// Represents all allowed values for the number of bits per components used when loading an image from memory.
